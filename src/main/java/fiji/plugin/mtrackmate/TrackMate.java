...
import fiji.plugin.mtrackmate.detection.SpotDetector;
...
import fiji.plugin.mtrackmate.detection.SpotGlobalDetector;
import fiji.plugin.mtrackmate.detection.SpotGlobalDetectorFactory;
import fiji.plugin.mtrackmate.features.EdgeFeatureCalculator;
import fiji.plugin.mtrackmate.features.FeatureFilter;
import fiji.plugin.mtrackmate.features.SpotFeatureCalculator;
import fiji.plugin.mtrackmate.features.TrackFeatureCalculator;
...
public class TrackMate implements Benchmark, MultiThreaded, Algorithm, Named, Cancelable
{
	...
	public static final String PLUGIN_NAME_STR = "MTrackMate";

	public static final String PLUGIN_NAME_VERSION = VersionUtils.getVersion( TrackMate.class );

	
	/**
	 * The model this mtrackmate will shape.
	 */
