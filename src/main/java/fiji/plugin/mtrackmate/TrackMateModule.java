 ...
 * 
 * This will have a
 * {@link fiji.plugin.mtrackmate.features.spot.SpotAnalyzerFactory} module
 ...
 * <ul>
 * <li>{@link fiji.plugin.mtrackmate.detection.SpotDetectorFactory}: generates
 * detectors for the detection step of TrackMate.
 * <li>{@link fiji.plugin.mtrackmate.features.spot.SpotAnalyzerFactory}:
 * generates analyzers that grant spots with scalar numerical features.
 * <li>{@link fiji.plugin.mtrackmate.visualization.ViewFactory}: generates views
 * that can display the detection and tracking results.
 * <li>{@link fiji.plugin.mtrackmate.tracking.SpotTrackerFactory}: generates
 * particle linkers for the tracking step of TrackMate.
 * <li>{@link fiji.plugin.mtrackmate.features.track.TrackAnalyzer}: compute
 * scalar numerical features for tracks.
 * <li>{@link fiji.plugin.mtrackmate.features.edges.EdgeAnalyzer}: compute scalar
 * numerical features for edges (individual links between spots).
 * <li>{@link fiji.plugin.mtrackmate.action.TrackMateActionFactory}: generates
