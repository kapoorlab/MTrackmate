...
import fiji.plugin.mtrackmate.gui.components.tracker.SimpleLAPTrackerSettingsPanel;
...
public class SimpleSparseLAPTrackerFactory extends SparseLAPTrackerFactory
{
	...
	public static final String THIS2_INFO_TEXT = "<html>"
			+ "This tracker is identical to the sparse LAP tracker present in this mtrackmate, except that it <br>"
