package fiji.plugin.mtrackmate.tracking.overlap;

import static fiji.plugin.mtrackmate.gui.Fonts.BIG_FONT;
import static fiji.plugin.mtrackmate.gui.Fonts.FONT;
import static fiji.plugin.mtrackmate.tracking.overlap.OverlapTrackerFactory.KEY_IOU_CALCULATION;
import static fiji.plugin.mtrackmate.tracking.overlap.OverlapTrackerFactory.KEY_MIN_IOU;
import static fiji.plugin.mtrackmate.tracking.overlap.OverlapTrackerFactory.KEY_SCALE_FACTOR;
...
import fiji.plugin.mtrackmate.tracking.overlap.OverlapTracker.IoUCalculation;
