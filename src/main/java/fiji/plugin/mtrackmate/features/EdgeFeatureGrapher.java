...
import fiji.plugin.mtrackmate.util.XYEdgeRenderer;
import fiji.plugin.mtrackmate.util.XYEdgeSeries;
import fiji.plugin.mtrackmate.util.XYEdgeSeriesCollection;
