...
import fiji.plugin.mtrackmate.detection.DetectionUtils;
import fiji.plugin.mtrackmate.detection.DetectorKeys;
...
import fiji.plugin.mtrackmate.features.FeatureAnalyzer;
 ...
 * mtrackmate. It is simply made of public fields
 */
public class Settings
{
	 ...
	 * {@link fiji.plugin.mtrackmate.visualization.TrackMateModelView} as a GUI
	 * target.
	 */
	 ...
	 * {@link fiji.plugin.mtrackmate.detection.SpotDetector} for each target
	 * frame.
	 */
	...
	/**
	 * Settings map for {@link fiji.plugin.mtrackmate.detection.SpotDetector}.
	 *
	 * @see fiji.plugin.mtrackmate.detection.DetectorKeys
	 */
	public Map< String, Object > detectorSettings = new HashMap<>();

	/**
	 * Settings map for {@link fiji.plugin.mtrackmate.tracking.SpotTracker}.
	 *
	 * @see fiji.plugin.mtrackmate.tracking.TrackerKeys
	 */
	 ...
	 *
	 * @param spotAnalyzer
	 *            the {@link fiji.plugin.mtrackmate.features.spot.SpotAnalyzer}
