...
import static fiji.plugin.mtrackmate.detection.DetectorKeys.KEY_DOWNSAMPLE_FACTOR;
import static fiji.plugin.mtrackmate.detection.DetectorKeys.KEY_DO_MEDIAN_FILTERING;
import static fiji.plugin.mtrackmate.detection.DetectorKeys.KEY_DO_SUBPIXEL_LOCALIZATION;
import static fiji.plugin.mtrackmate.detection.DetectorKeys.KEY_RADIUS;
import static fiji.plugin.mtrackmate.detection.DetectorKeys.KEY_TARGET_CHANNEL;
import static fiji.plugin.mtrackmate.detection.DetectorKeys.KEY_THRESHOLD;
