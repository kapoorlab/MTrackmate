...
import fiji.plugin.mtrackmate.gui.wizard.descriptors.SomeDialogDescriptor;
import fiji.plugin.mtrackmate.io.IOUtils;
import fiji.plugin.mtrackmate.io.TmXmlReader;
...
public class LoadTrackMatePlugIn extends SomeDialogDescriptor implements PlugIn
{
	...
	public void run( final String filePath )
	{
		...
		final TrackMate mtrackmate = new TrackMate( model, settings );
		...
		// Wizard.
		final BTrackMateWizardSequence sequence = new BTrackMateWizardSequence( mtrackmate, selectionModel, displaySettings );
	 ...
	 */
	protected void postRead( final TrackMate mtrackmate )
	{}
