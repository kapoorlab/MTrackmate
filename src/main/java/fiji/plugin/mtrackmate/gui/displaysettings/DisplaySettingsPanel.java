package fiji.plugin.mtrackmate.gui.displaysettings;

import static fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.booleanElement;
import static fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.boundedDoubleElement;
import static fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.colorElement;
import static fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.colormapElement;
import static fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.doubleElement;
import static fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.enumElement;
import static fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.featureElement;
import static fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.fontElement;
import static fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.intElement;
import static fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.label;
import static fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.linkedCheckBox;
import static fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.linkedColorButton;
import static fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.linkedColormapChooser;
import static fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.linkedFeatureSelector;
import static fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.linkedFontButton;
import static fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.linkedFormattedTextField;
import static fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.linkedSliderPanel;
import static fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.linkedSpinnerEnumSelector;
import static fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.separator;
...
import fiji.plugin.mtrackmate.gui.displaysettings.DisplaySettings.TrackDisplayMode;
import fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.BooleanElement;
import fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.BoundedDoubleElement;
import fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.ColorElement;
import fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.ColormapElement;
import fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.DoubleElement;
import fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.EnumElement;
import fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.FeatureElement;
import fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.FontElement;
import fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.IntElement;
import fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.LabelElement;
import fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.Separator;
import fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.StyleElement;
import fiji.plugin.mtrackmate.gui.displaysettings.StyleElements.StyleElementVisitor;
