...
import static fiji.plugin.mtrackmate.gui.Icons.CANCEL_ICON;
import static fiji.plugin.mtrackmate.gui.Icons.DISPLAY_CONFIG_ICON;
import static fiji.plugin.mtrackmate.gui.Icons.LOG_ICON;
import static fiji.plugin.mtrackmate.gui.Icons.NEXT_ICON;
import static fiji.plugin.mtrackmate.gui.Icons.PREVIOUS_ICON;
import static fiji.plugin.mtrackmate.gui.Icons.REVERT_ICON;
import static fiji.plugin.mtrackmate.gui.Icons.SAVE_ICON;
...
import fiji.plugin.mtrackmate.gui.wizard.TransitionAnimator.Direction;
import fiji.plugin.mtrackmate.util.EverythingDisablerAndReenabler;
