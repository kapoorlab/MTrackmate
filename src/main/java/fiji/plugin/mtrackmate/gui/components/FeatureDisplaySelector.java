...
import static fiji.plugin.mtrackmate.features.FeatureUtils.collectFeatureKeys;
import static fiji.plugin.mtrackmate.gui.Fonts.SMALL_FONT;
import static fiji.plugin.mtrackmate.gui.displaysettings.DisplaySettings.TrackMateObject.DEFAULT;
import static fiji.plugin.mtrackmate.gui.displaysettings.DisplaySettings.TrackMateObject.EDGES;
import static fiji.plugin.mtrackmate.gui.displaysettings.DisplaySettings.TrackMateObject.SPOTS;
import static fiji.plugin.mtrackmate.gui.displaysettings.DisplaySettings.TrackMateObject.TRACKS;
...
import fiji.plugin.mtrackmate.ModelChangeEvent;
...
import fiji.plugin.mtrackmate.gui.displaysettings.Colormap;
