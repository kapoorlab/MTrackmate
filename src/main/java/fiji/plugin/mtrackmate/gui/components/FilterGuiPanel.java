...
import static fiji.plugin.mtrackmate.features.FeatureUtils.collectFeatureValues;
import static fiji.plugin.mtrackmate.features.FeatureUtils.nObjects;
import static fiji.plugin.mtrackmate.gui.Fonts.BIG_FONT;
import static fiji.plugin.mtrackmate.gui.Fonts.SMALL_FONT;
import static fiji.plugin.mtrackmate.gui.Icons.ADD_ICON;
import static fiji.plugin.mtrackmate.gui.Icons.REMOVE_ICON;
...
import fiji.plugin.mtrackmate.util.OnRequestUpdater;
