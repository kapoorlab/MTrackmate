...
import static fiji.plugin.mtrackmate.gui.Icons.CAMERA_ICON;
...
public class CaptureOverlayAction extends AbstractTMAction
{
	...
	{
		final ImagePlus imp = mtrackmate.getSettings().imp;
		...
		final ImagePlus capture = capture( mtrackmate, firstFrame, lastFrame );
		capture.show();
	}
	 ...
	 */
	public static ImagePlus capture( final TrackMate mtrackmate, final int first, final int last )
	{
