...
import static fiji.plugin.mtrackmate.gui.Icons.LABEL_IMG_ICON;
...
public class LabelImgExporter extends AbstractTMAction
{
	...
	@Override
	public void execute( final TrackMate mtrackmate, final SelectionModel selectionModel, final DisplaySettings displaySettings, final Frame gui )
	{
		/*
		 * Ask use for option.
		 */
		...
		createLabelImagePlus( mtrackmate, exportSpotsAsDots, exportTracksOnly, logger ).show();
	}
	 ...
	 *
	 * @param mtrackmate
	 *            the mtrackmate instance from which we takes the spots to paint.
	 *            The label image will have the same calibration, name and
	 *            dimension from the input image stored in the mtrackmate
	...
	public static final ImagePlus createLabelImagePlus(
			final TrackMate mtrackmate,
			final boolean exportSpotsAsDots,
			final boolean exportTracksOnly )
	{
		return createLabelImagePlus( mtrackmate, exportSpotsAsDots, exportTracksOnly, Logger.VOID_LOGGER );
	}
	...
	public static final ImagePlus createLabelImagePlus(
			...
			final Logger logger )
	{
		return createLabelImagePlus( mtrackmate.getModel(), mtrackmate.getSettings().imp, exportSpotsAsDots, exportTracksOnly, logger );
	}
