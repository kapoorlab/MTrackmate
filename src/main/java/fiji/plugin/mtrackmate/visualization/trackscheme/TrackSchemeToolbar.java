...
import static fiji.plugin.mtrackmate.gui.Icons.CAPTURE_DECORATED_ICON;
import static fiji.plugin.mtrackmate.gui.Icons.CAPTURE_UNDECORATED_ICON;
import static fiji.plugin.mtrackmate.gui.Icons.DISPLAY_DECORATIONS_ON_ICON;
import static fiji.plugin.mtrackmate.gui.Icons.LINKING_OFF_ICON;
import static fiji.plugin.mtrackmate.gui.Icons.LINKING_ON_ICON;
import static fiji.plugin.mtrackmate.gui.Icons.REFRESH_ICON;
import static fiji.plugin.mtrackmate.gui.Icons.RESET_ZOOM_ICON;
import static fiji.plugin.mtrackmate.gui.Icons.SELECT_STYLE_ICON;
import static fiji.plugin.mtrackmate.gui.Icons.THUMBNAIL_OFF_ICON;
import static fiji.plugin.mtrackmate.gui.Icons.THUMBNAIL_ON_ICON;
...
import fiji.plugin.mtrackmate.visualization.trackscheme.utils.SearchBar;
